...
class Swim(tk.Tk):
    ...
    def create_menu_label(self):
        ...
        MenuLabel(self, text="Pace", rely_value=0.49, background="PaleTurquoise2")
    ...
    def create_label_entry_gap(self):
        ...
        EntryLabel(self, text="min", relx_value=0.545, rely_value=0.49, relwidth_value=0.06)
        EntryLabel(self, text="secs", relx_value=0.71, rely_value=0.49, relwidth_value=0.06)
